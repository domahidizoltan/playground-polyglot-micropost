...
public class MicropostRecord extends UpdatableRecordImpl<MicropostRecord> implements Record4<Integer, String, LocalTime, String> {

    private static final long serialVersionUID = -1366591004;
     ...
     */
    public MicropostRecord setCreatedAt(LocalTime value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public Row4<Integer, String, LocalTime, String> fieldsRow() {
     ...
     */
    @Override
    public Row4<Integer, String, LocalTime, String> valuesRow() {
     ...
     */
    @Override
    public MicropostRecord value3(LocalTime value) {
        setCreatedAt(value);
        return this;
    }
     ...
     */
    @Override
    public MicropostRecord values(Integer value1, String value2, LocalTime value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MicropostRecord(Integer id, String content, LocalTime createdAt, String userId) {
        super(Micropost.MICROPOST);
